...
### Users
People who want to be more intentional about how they spend their time across all areas of life — work, study, health, creativity, rest. They open Chrona during transitions: before starting a session to commit, during idle moments to check in, and at day's end to reflect. They're self-aware, care about quality over quantity, and want the app to help them enter (and stay in) a flow state — not gamify or nag them.
